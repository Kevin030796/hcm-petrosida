...
public class HC_JobDataChangeCompleteAll extends SvrProcess{
	...
	protected String doIt() throws Exception {
		...
		int[] jobDataChanges = new Query(getCtx(), MJobDataChange.Table_Name, "AD_Client_ID=1000013", get_TrxName())
							.setOnlyActiveRecords(true)
							.getIDs();
		
		int count = 1;
		
		for (int jobDataChangeID : jobDataChanges) {
			p_JobDataChange_ID = jobDataChangeID;
		...
		return "Successfully Updated " + count + " Job Data" ;
	}
