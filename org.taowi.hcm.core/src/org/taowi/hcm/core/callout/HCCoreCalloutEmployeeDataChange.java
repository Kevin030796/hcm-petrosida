...
public class HCCoreCalloutEmployeeDataChange extends CalloutEngine implements IColumnCallout {
	...
	public String start(Properties ctx, int WindowNo, GridTab mTab,
		...
		}else if(mField.getColumnName().equals(MEmployeeDataChange.COLUMNNAME_C_BPartner_ID)){
