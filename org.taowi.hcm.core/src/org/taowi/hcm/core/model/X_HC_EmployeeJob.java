...
public class X_HC_EmployeeJob extends PO implements I_HC_EmployeeJob, I_Persistent 
{
	...
	/** Set Biaya Dapur.
		@param HC_Compensation3 Biaya Dapur	  */
	...
	public void setHC_EmployeeCategory_ID (int HC_EmployeeCategory_ID)
	{
		if (HC_EmployeeCategory_ID < 1) 
			set_Value (COLUMNNAME_HC_EmployeeCategory_ID, null);
		else 
			set_Value (COLUMNNAME_HC_EmployeeCategory_ID, Integer.valueOf(HC_EmployeeCategory_ID));
	}
	...
	public void setHC_EmployeeClass_ID (int HC_EmployeeClass_ID)
	{
		if (HC_EmployeeClass_ID < 1) 
			set_Value (COLUMNNAME_HC_EmployeeClass_ID, null);
		else 
			set_Value (COLUMNNAME_HC_EmployeeClass_ID, Integer.valueOf(HC_EmployeeClass_ID));
	}
	...
	{
		if (HC_PayGroup_ID < 1) 
			set_Value (COLUMNNAME_HC_PayGroup_ID, null);
		else 
			set_Value (COLUMNNAME_HC_PayGroup_ID, Integer.valueOf(HC_PayGroup_ID));
	}
	...
	{
		if (HC_Position_ID < 1) 
			set_Value (COLUMNNAME_HC_Position_ID, null);
		else 
			set_Value (COLUMNNAME_HC_Position_ID, Integer.valueOf(HC_Position_ID));
	}
	...
	{
		if (HC_Reason_ID < 1) 
			set_Value (COLUMNNAME_HC_Reason_ID, null);
		else 
			set_Value (COLUMNNAME_HC_Reason_ID, Integer.valueOf(HC_Reason_ID));
	}
	...
	/** Set Registered In BPJS?.
		@param IsRegisteredInBPJS Registered In BPJS?	  */
	public void setIsRegisteredInBPJS (boolean IsRegisteredInBPJS)
	{
		set_Value (COLUMNNAME_IsRegisteredInBPJS, Boolean.valueOf(IsRegisteredInBPJS));
	}

	/** Get Registered In BPJS?.
		@return Registered In BPJS?	  */
	public boolean isRegisteredInBPJS () 
	{
		Object oo = get_Value(COLUMNNAME_IsRegisteredInBPJS);
		if (oo != null) 
		{
