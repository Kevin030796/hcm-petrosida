...
public class X_HC_EmployeeDataChange extends PO implements I_HC_EmployeeDataChange, I_Persistent 
{
	...
	/** National ID Change = IDC */
	public static final String HC_PERSONALDATAACTION_NationalIDChange = "IDC";
	/** Address Change = ADC */
	...
	/** Email Change = EMC */
	public static final String HC_PERSONALDATAACTION_EmailChange = "EMC";
