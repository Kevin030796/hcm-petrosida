package org.taowi.hcm.imported.classes;
...
public class TimeUtil
{
	...
	public static void main (String[] args)
	{
		...
		String endDate = "2016-12-31 17:49:00.493";
		Timestamp today = Timestamp.valueOf(endDate);
		String Date = today.toString().substring(0, 10);
		String time = today.toString().substring(11,21);
